...
describe('Kraw Tests', () => {
    ...
    const source: MangaStream = new Kraw(cheerio)
   ...
   */
    const mangaId = 'manga/c99-yuki-iro-yukiusagi-maryoku-hokyuuchuu-touhou-project-english-desudesu' // the-kingdoms-of-ruin
